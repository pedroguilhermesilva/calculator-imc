...
public class JFCalculadora extends javax.swing.JFrame {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jTResultado, javax.swing.GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE)
                                    .addComponent(jTPeso))))))
    ...
    public String verificarIMC(float valor)
    {
        ...
        if(valor>30 && valor<=35)
            resultado="Obessidade (grau I)";
        if(valor>35 && valor<=40)
            resultado="Obessidade (grau II)";
        if(valor>40)
            resultado="Obessidade (grau III)";
            return resultado;
    }
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        float altura=Float.valueOf(jTAltura.getText());
        float peso=Float.valueOf(jTPeso.getText());
        
        float imc=peso/(altura*altura);
        
        jTResultado.setText(String.valueOf(verificarIMC(imc)));
